...
<body class="body">
  ...
  <div id="home" class="site-container">
    <div data-collapse="tiny" data-animation="default" data-duration="400" class="navbar w-nav">
      ...
      <nav role="navigation" class="nav-menu w-nav-menu"><a href="#" id="stopvideo-about" data-w-id="d7075c52-82ca-d741-0331-9c17b0ecac46" class="nav-link w-nav-link">à Propos</a><a href="#" id="stopvideo-contact" data-w-id="d7075c52-82ca-d741-0331-9c17b0ecac48" class="nav-link w-nav-link">Contact</a></nav>
